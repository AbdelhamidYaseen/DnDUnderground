  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="An overview of all magic items." />
      </Head>
      ...
      <div style={{ padding: "1rem" }}>
        ...
        <div style={{ marginLeft: "auto", marginRight: "auto", width: "85%" }}>
          ...
          <div className={base.PaginationHolder}>
            ...
            {nextpage.length !== 0 ? (
              <>
                <button onClick={handleNextPage} className={base.Next}>
                  {currentPage + 1}
                </button>
                <button onClick={handleLastPage} className={base.Next}>
                  &gt;&gt;
                </button>
              </>
            ) : (
...
export async function getServerSideProps(
  ...
  const urlMaker = (
    ...
    let url = `http://127.0.0.1:59001/jsonapi/node/artifact?page[offset]=${
      page * limit
    }`;
    if (amount != null) {
  ...
  const params = new DrupalJsonApiParams()
    .addFields("node--artifact", [
      "title",
      "path",
      "uid",
      "field_description",
      "field_rarity",
      "field_requires_attunement",
      "field_type",
    ])
